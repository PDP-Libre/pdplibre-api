...
class FacilityPayloadHistoryUle extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     * 
     *
     * @param LegalUnitPayloadIncludedNoSiren $uniteLegale
     *
     * @return self
     */
    public function setUniteLegale(LegalUnitPayloadIncludedNoSiren $uniteLegale): self
    {
