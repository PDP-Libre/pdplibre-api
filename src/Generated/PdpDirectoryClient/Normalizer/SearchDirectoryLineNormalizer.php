...
class SearchDirectoryLineNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \PdpLibre\Generated\PdpFPdpDirectoryClient\Model\SearchDirectoryLine::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \PdpLibre\Generated\PdpFPdpDirectoryClient\Model\SearchDirectoryLine::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \PdpLibre\Generated\PdpFPdpDirectoryClient\Model\SearchDirectoryLine();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('filters', $data)) {
            $object->setFilters($this->denormalizer->denormalize($data['filters'], \PdpLibre\Generated\PdpFPdpDirectoryClient\Model\SearchDirectoryLineFilters::class, 'json', $context));
            unset($data['filters']);
        }
        if (\array_key_exists('sorting', $data)) {
            $values = [];
            foreach ($data['sorting'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \PdpLibre\Generated\PdpFPdpDirectoryClient\Model\SearchDirectoryLineSortingInner::class, 'json', $context);
            }
    ...
    {
        return [\PdpLibre\Generated\PdpFPdpDirectoryClient\Model\SearchDirectoryLine::class => false];
    }
}