...
class RoutingCodeSearchNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \App\Generated\PdpDirectoryClient\Model\RoutingCodeSearch::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \App\Generated\PdpDirectoryClient\Model\RoutingCodeSearch::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \App\Generated\PdpDirectoryClient\Model\RoutingCodeSearch();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('filters', $data)) {
            $object->setFilters($this->denormalizer->denormalize($data['filters'], \App\Generated\PdpDirectoryClient\Model\RoutingCodeSearchFilters::class, 'json', $context));
            unset($data['filters']);
        }
        if (\array_key_exists('sorting', $data)) {
            $values = [];
            foreach ($data['sorting'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \App\Generated\PdpDirectoryClient\Model\RoutingCodeSearchSortingInner::class, 'json', $context);
            }
    ...
    {
        return [\App\Generated\PdpDirectoryClient\Model\RoutingCodeSearch::class => false];
    }
}