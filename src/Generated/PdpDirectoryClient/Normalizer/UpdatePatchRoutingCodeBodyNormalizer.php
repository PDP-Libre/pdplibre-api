...
class UpdatePatchRoutingCodeBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \App\Generated\PdpDirectoryClient\Model\UpdatePatchRoutingCodeBody::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \App\Generated\PdpDirectoryClient\Model\UpdatePatchRoutingCodeBody::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \App\Generated\PdpDirectoryClient\Model\UpdatePatchRoutingCodeBody();
        ...
        if (\array_key_exists('address', $data)) {
            $object->setAddress($this->denormalizer->denormalize($data['address'], \App\Generated\PdpDirectoryClient\Model\AddressPatch::class, 'json', $context));
            unset($data['address']);
        }
    ...
    {
        return [\App\Generated\PdpDirectoryClient\Model\UpdatePatchRoutingCodeBody::class => false];
    }
}